...
import styles from '../styles/VehicleRemarketing.module.css'
        ...
        <div className={styles.container}>
            ...
            <section className={styles.heroSection}>
                <div className={styles.heroContent}>
                    <h1 className={styles.heroTitle}>AI powered vehicle inspection to help you maximize vehicle resale value</h1>
                    <p className={styles.heroText}>
                    Automate vehicle condition reports, build buyer trust, and sell used vehicles faster, with inspection data you can always trust
                    </p>
                    <div
            ...
            <section className={styles.workflowSection}>
                <div className={styles.workflowContent}>
                    <h2 className={styles.sectionHeading}>
                        Manual Inspection are costing you time & buyer confidence
                    </h2>
            ...
            <section className={styles.builtForSection}>
                <div className={styles.builtForContent}>
                    ...
                    <h2 className={styles.sectionHeading}>
                        Turn every vehicle into a transparent listing within minutes
                    </h2>
            ...
            <section className={styles.faqSectionContainer}>
                <div className={styles.faqSection}>
                    ...
                    <div className={styles.faqGrid}>
                        {questions["Vehicle Remarketing"][locale].map((item, index) => (
